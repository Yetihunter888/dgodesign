...
export default function CaseStudyTemplate({ 
  ...
  subtitle = "Reimagining the contact center management dashboard for increased efficiency and reduced cognitive load.",
          ...
          <div className="max-w-6xl mx-auto bg-surface-container-low/50 p-8 md:p-16 rounded-[2rem] border border-surface-container-high relative overflow-hidden">
            ...
            <div className="relative z-10">
              <div className="mb-16">
                ...
                <p className="mt-6 text-on-surface-variant max-w-2xl text-lg">Through deep contextual inquiry, we uncovered the friction in the daily life of a contact center supervisor.</p>
              </div>
        ...
        <section className="py-24 px-12 md:px-24 bg-surface-container-low">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-16 aspect-video rounded-3xl overflow-hidden border border-white/5 shadow-2xl bg-on-secondary-fixed">
              <img alt="Intelligent Architecture: Data Flow & Control" className="w-full h-full object-cover" src="/data-flow.png" referrerPolicy="no-referrer" />
            </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
              <div className="max-w-2xl">
                ...
                <p className="text-on-surface-variant">We architected a dashboard that functions as a command tower, prioritizing the "Human Element" of the contact center. The platform was built from scratch to strategically avoid legacy tech debt, ensuring a very lightweight and high-performance product experience.</p>
              </div>
            </div>
            <div className="space-y-32">
              ...
              <div className="grid md:grid-cols-2 gap-16 items-center">
                ...
                <div className="order-1 md:order-2">
                  ...
                  <p className="text-on-surface-variant leading-relaxed mb-8">
                    Clicking an agent doesn't take you to a new page; it unfolds a contextual layer. View sentiment analysis, call history, and performance trends without losing floor context.
                  </p>
                  <div className="p-6 bg-surface-container-low rounded-lg">
                    ...
                    <div className="flex gap-4">
                      <span className="px-3 py-1 bg-surface-container-lowest text-[10px] font-bold rounded uppercase tracking-tighter">Monitor</span>
                      <span className="px-3 py-1 bg-surface-container-lowest text-[10px] font-bold rounded uppercase tracking-tighter">Barge</span>
                      <span className="px-3 py-1 bg-primary text-white text-[10px] font-bold rounded uppercase tracking-tighter" style={{ backgroundColor: '#FF7F50' }}>Take Over</span>
                    </div>
                  </div>
                </div>
              </div>
              <div className="grid md:grid-cols-2 gap-16 items-center">
                <div>
                  ...
                  <p className="text-on-surface-variant leading-relaxed mb-8">
                    Instead of complex skill mapping, we introduced 'Levers'—a tactile way to rebalance teams. Shift an agent's focus from Email to Voice with a single slider.
                  </p>
